...
public class ViewPagerRectIndicator extends LinearLayout implements Indicator {
     ...
     * 标题正常时的颜色
     */
    private int color_text_normal = 0x77333333;
    /**
     * 标题选中时的颜色
     */
    private int color_text_highlightcolor = 0xFF333333;
    /**
     * 普通字体大小
     */
    ...
    矩形的颜色
    * */
    private int mRectColor = 0xff0000;
...
// 获得自定义属性，tab的数量
        ...
        if (a != null) {
            ...
            size_text_normal = (int) a.getDimension(R.styleable.viewpagerindicator_size_text_normal,
                    size_text_normal);
            mRectColor = a.getColor(R.styleable.viewpagerindicator_indicatorColor,
                    mRectColor);
            a.recycle();
        }
        // 初始化画笔
