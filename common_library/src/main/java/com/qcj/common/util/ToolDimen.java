...
/**
 * Created by cdy on 2016-02-03.
 * Quoted by leoray on 2017-08-28.
 * 快速生成适配工具类: 独立运行，根据默认dimen配置，计算、适配其它分辨率的屏幕
 * 建立所需分辨率的values文件夹、建立dimen文件、配置gen()算法、运行此工具
 */

public class ToolDimen {
