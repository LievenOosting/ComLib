...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & BaseApplication.getInstance()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = BaseApplication.getInstance()
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean hasInternet() {
        boolean flag;
        if (((ConnectivityManager) BaseApplication.getInstance().getSystemService(
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = BaseApplication.getInstance().getPackageManager()
    ...
    public static void hideSoftKeyboard(View view) {
        if (view == null)
            return;
        ((InputMethodManager) BaseApplication.getInstance().getSystemService(
    ...
    public static String getCurCountryLan() {
        return BaseApplication.getInstance().getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + BaseApplication.getInstance().getResources().getConfiguration().locale
                .getCountry();
    }
    ...
    public static String getVersionName() {
        String name = "";
        try {
            name = BaseApplication.getInstance()
                    .getPackageManager()
                    .getPackageInfo(BaseApplication.getInstance().getPackageName(),
                            0).versionName;
        } catch (NameNotFoundException ex) {
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = BaseApplication.getInstance().getPackageManager()
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = BaseApplication.getInstance().getResources()
                    .getDimensionPixelSize(x);
